const fs = require("fs");
const burgerData = require("../sandwich/data.json");
...
module.exports.updateImageFileNamesWithBurgerNames =
  function updateImageFileNamesWithBurgerNames() {
    ...
    //     path.join(__dirname, "images", slug),
    //     err => {
...
module.exports.updateImageUrls = function updateImageUrls() {
  burgerData.forEach(burger => {
    ...
    const imageUrl = `https://res.cloudinary.com/joelmturner/image/upload/v1673642765/sandwichweek/2022/${slug}.jpg`;
